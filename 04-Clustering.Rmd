...
```{r}
load('~/data/gwas_catalog/diseaseGR-26-6-2017.RData')
```
...
The GWAS catalog had `r length(unique(obesity_GR$SYMBOL))` genes associated Obesity, this was represented by XXX windows.
