...
```{r allpopPCA, fig.cap = '(ref:allpopPCA)', echo = FALSE, fig.height = 6, fig.width=5, fig.align='center'}
...
```{r admix, echo = FALSE, fig.height = 8, fig.width = 6, fig.cap = '(ref:admix)', warning=FALSE}
...
```{r multichrplot, fig.cap='(ref:multichrplot)', echo = FALSE, fig.height=6}
...
```{r ihsclust, fig.cap='(ref:ihsclust)', echo = FALSE, fig.asp = 1, warning = FALSE}
ihs_dendro_plot()
...
```{r nslclust, fig.cap='(ref:nslclust)', echo = FALSE, fig.asp= 1, warning=FALSE }
nsl_dendro_plot()
...
(ref:goutdendros) Dendrograms created from hierarchical clustering applied to windows from the `r length(unique(gc_urate_gout_GR$SYMBOL))` loci associated with urate and gout. Coloured by super population.
