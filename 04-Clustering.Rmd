...
(ref:tdTop1000) _\gls{td} Clustering._ Hierarchical clustering of \gls{td} using the upper and lower 1% of the distribution. **A** and **B** Dendrograms representing the clusters of \gls{td} lower and upper tails respectively, using hierarchical clustering with Euclidean distance and complete linkage, and coloured by super population. **C** and **D** Plots representing the windows present in each population from the lower and upper tails respectively. A blue line represents presence of a window, white represents the absence of a window in the 1% of the distribution for a population.
...
(ref:fwhTop1000) _\gls{fwh} Clustering._ Hierarchical clustering of \gls{fwh} using the upper and lower 1% of the distribution. **A** and **B** Dendrograms representing the clusters of \gls{fwh} lower and upper tails respectively, using hierarchical clustering with Euclidean distance and complete linkage, and coloured by super population. **C** and **D** Plots representing the windows present in each population from the lower and upper tails respectively. A blue line represents presence of a window, white represents the absence of a window in the 1% of the distribution for a population.
...
(ref:flfTop1000) _\gls{flf} Clustering._ Hierarchical clustering of \gls{flf} using the upper and lower 1% of the distribution. **A** and **B** Dendrograms representing the clusters of \gls{flf} lower and upper tails respectively, using hierarchical clustering with Euclidean distance and complete linkage, and coloured by super population. **C** and **D** Plots representing the windows present in each population from the lower and upper tails respectively. A blue line represents presence of a window, white represents the absence of a window in the 1% of the distribution for a population.
...
(ref:zeTop1000) _\gls{ze} Clustering._ Hierarchical clustering of \gls{ze} using the upper and lower 1% of the distribution. **A** and **B** Dendrograms representing the clusters of \gls{ze} lower and upper tails respectively, using hierarchical clustering with Euclidean distance and complete linkage, and coloured by super population. **C** and **D** Plots representing the windows present in each population from the lower and upper tails respectively. A blue line represents presence of a window, white represents the absence of a window in the 1% of the distribution for a population.
...
#### Summary of clustering on extremes
...
#### \hl{Summary of clustering on haplotypic regions}
...
<!-- >Tony: doesn't make sense -> -->

<!-- >In the context of modern metabolic disease, the question being asked is, is there evidence in the ancestral populations of selection in metabolic disease associated loci that is in common with the Polynesian populations? -->
