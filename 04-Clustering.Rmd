...
td_neg_pol_genes <- left_join(td_neg_pol, txdb_gene_annotate(GenomicRanges::GRanges(td_neg_pol)), by = c('chrom' = 'seqnames', "chrom_start" = 'start', "chrom_end" = 'end')) %>% select(-width)

# Look at the genes to see how many other pops had them too
td_neg_pol_genes %>% filter( SYMBOL %in% genelists$genename) %>% select(contains('chrom'),SYMBOL,  ALLsum, AFRsum, EURsum, SASsum, EASsum, POLsum, contains("EAS"), contains("POL")) %>% arrange(desc(POLsum)) %>%  View()
...
td_no_pol_genes <- txdb_gene_annotate(create_sums('td_neg') %>% filter(POLsum == 0) %>% mutate(chrom = paste0('chr', chrom)) %>% GenomicRanges::GRanges()) %>% pull(SYMBOL) %>% unique()
# find how many genes were only found with the Pols + others
td_neg_pol_genes %>% filter(!SYMBOL %in% td_no_pol_genes, SYMBOL %in% genelists$genename) %>% pull(SYMBOL) %>% unique() %>% length()
```
...
# annotate the windows with gene names
td_pos_pol_genes <- left_join(td_pos_pol, txdb_gene_annotate(GenomicRanges::GRanges(td_pos_pol)), by = c('chrom' = 'seqnames', "chrom_start" = 'start', "chrom_end" = 'end')) %>% select(-width)
...
# get the genes that were in windows that the Pol pops weren't in
td_no_pol_genes <- txdb_gene_annotate(create_sums('td_pos') %>% filter(POLsum == 0) %>% mutate(chrom = paste0('chr', chrom)) %>% GenomicRanges::GRanges()) %>% pull(SYMBOL) %>% unique()
# find how many genes were only found with the Pols + others
td_pos_pol_genes %>% filter(!SYMBOL %in% td_no_pol_genes, SYMBOL %in% genelists$genename) %>% pull(SYMBOL) %>% unique() %>% length()
```
...
# annotate the windows with gene names
fwh_neg_pol_genes <- left_join(fwh_neg_pol, txdb_gene_annotate(GenomicRanges::GRanges(fwh_neg_pol)), by = c('chrom' = 'seqnames', "chrom_start" = 'start', "chrom_end" = 'end')) %>% select(-width)
...
# get the genes that were in windows that the Pol pops weren't in
fwh_no_pol_genes <- txdb_gene_annotate(create_sums('fwh_neg') %>% filter(POLsum == 0) %>% mutate(chrom = paste0('chr', chrom)) %>% GenomicRanges::GRanges()) %>% pull(SYMBOL) %>% unique()
# find how many genes were only found with the Pols + others
...
# annotate the windows with gene names
fwh_pos_pol_genes <- left_join(fwh_pos_pol, txdb_gene_annotate(GenomicRanges::GRanges(fwh_pos_pol)), by = c('chrom' = 'seqnames', "chrom_start" = 'start', "chrom_end" = 'end')) %>% select(-width)
...
# get the genes that were in windows that the Pol pops weren't in
fwh_no_pol_genes <- txdb_gene_annotate(create_sums('fwh_pos') %>% filter(POLsum == 0) %>% mutate(chrom = paste0('chr', chrom)) %>% GenomicRanges::GRanges()) %>% pull(SYMBOL) %>% unique()
# find how many genes were only found with the Pols + others
fwh_pos_pol_genes %>% filter(!SYMBOL %in% fwh_no_pol_genes, SYMBOL %in% genelists$genename) %>% pull(SYMBOL) %>% unique() %>% length()
```
...
# annotate the windows with gene names
fld_neg_pol_genes <- left_join(fld_neg_pol, txdb_gene_annotate(GenomicRanges::GRanges(fld_neg_pol)), by = c('chrom' = 'seqnames', "chrom_start" = 'start', "chrom_end" = 'end')) %>% select(-width)
...
# annotate the windows with gene names
fld_pos_pol_genes <- left_join(fld_pos_pol, txdb_gene_annotate(GenomicRanges::GRanges(fld_pos_pol)), by = c('chrom' = 'seqnames', "chrom_start" = 'start', "chrom_end" = 'end')) %>% select(-width)
...
# annotate the windows with gene names
flf_neg_pol_genes <- left_join(flf_neg_pol, txdb_gene_annotate(GenomicRanges::GRanges(flf_neg_pol)), by = c('chrom' = 'seqnames', "chrom_start" = 'start', "chrom_end" = 'end')) %>% select(-width)
...
# annotate the windows with gene names
flf_pos_pol_genes <- left_join(flf_pos_pol, txdb_gene_annotate(GenomicRanges::GRanges(flf_pos_pol)), by = c('chrom' = 'seqnames', "chrom_start" = 'start', "chrom_end" = 'end')) %>% select(-width)
...
# annotate the windows with gene names
ze_neg_pol_genes <- left_join(ze_neg_pol, txdb_gene_annotate(GenomicRanges::GRanges(ze_neg_pol)), by = c('chrom' = 'seqnames', "chrom_start" = 'start', "chrom_end" = 'end')) %>% select(-width)
...
# annotate the windows with gene names
ze_pos_pol_genes <- left_join(ze_pos_pol, txdb_gene_annotate(GenomicRanges::GRanges(ze_pos_pol)), by = c('chrom' = 'seqnames', "chrom_start" = 'start', "chrom_end" = 'end')) %>% select(-width)
...
Prior to this study there has only been a few studies that have genetically established the relationship of the Polynesian genome with respect to other populations. Recent studies have done this predominantly though the mitochondrial and Y chromosome lineages.
