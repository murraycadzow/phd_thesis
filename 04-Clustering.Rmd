...
NEED TO UPDATE THE iHS/nSL CLUSTERS AS THE THRESHOLD WAS INCORRECT
...
```{r tdTop1000, fig.cap='(ref:tdTop1000)', fig.subcap= "**A** and **B** Dendrogram representing the clusters of \\gls{td} lower and upper tails respectfully using hierarchical clustering with Euclidean distance and complete linkage. Coloured by super population. **C** and **D** Plots representing the windows present in each population from the lower and upper tails respectfully. A blue line represents presence of a window, white represents the absence of a window in the 1% of the distribution for a population.",echo = FALSE, fig.height = 7}
...
(ref:tdTop1000) _\gls{td} Clustering._ Hierarchical clustering of \gls{td} using the upper and lower 1% of the distribution.
...
The haplotypyic clustering results were similar to @pickrell2009signals
