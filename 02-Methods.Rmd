...
```{r diseaseListKeywords, eval = FALSE, echo = TRUE, tidy=TRUE}
...
The first 10 principle components were calculated using smartPCA v13050 from Eigensoft v6.0.1 [@Price2006]. All chromosomes were combined into a single \gls{vcf} file and then the independent markers were found by using a sliding window to remove markers that had an R^2^ > 0.2 in windows of 50 kb and a slide of 5 markers. 
