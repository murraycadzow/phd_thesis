...
- Eta (variscan) total (minimum number) number of mutations (η) 
...
knitr::knit('~/Git_repos/R_notebooks/thesis_tables.Rmd', tangle=TRUE)
```

```{r, echo=FALSE, results='asis', message=FALSE, warning=FALSE}
source("thesis_tables.R")
```
...
===|===|===
1000 genomes phased haplotypes | |
hs37d5 | | 
Ancestral allele | | 
