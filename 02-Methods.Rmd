...
When the \gls{vcf} files were loaded into the R package PopGenome (vXXX, @Pfeifer2014) populations were identified using panel files which were whitespace delimited files with sample id, population, and super population as the columns. The outgroup population was set to be that of the Ancestor sample.
...
# sort
java -Xmx8g -jar $EBROOTPICARD/picard.jar SortSam \                                      INPUT=$DIR/temp/${sample}_aligned_reads_${i}.bam \
...
```
parallel -j 22 'java -Xmx8g -jar /Volumes/BiochemXsan/scratch/merrimanlab/CoreTools/CurrentVersions/GATK/GenomeAnalysisTK-3.6/GenomeAnalysisTK.jar -T CombineGVCFs -R /Volumes/BiocArchive/archive/merrimanlab/reference_files/FASTA/hs37d5/hs37d5.fa  $(find ./ -name \*_{2}.raw*.g.vcf | tr "\n" " " |sed "s/ $//g" | sed "s/ / -V /g" |sed "s/^/ -V /g\") -o ../combined_gvcf/{1}_{2}.raw.snps.indels.g.vcf -log ../combined_gvcf/{1}_combine_{2}.log -L {2} && pigz -p 4 ../combined_gvcf/{1}_{2}.raw.snps.indels.g.vcf ' ::: man015 ::: $(seq 1 22)


/Volumes/BiochemXsan/scratch/merrimanlab/CoreTools/CurrentVersions/GATK/GenomeAnalysisTK-3.6/GenomeAnalysisTK.jar \
 -T GenotypeGVCFs \
...
java -Xmx48g -jar \ 
  ...
  -resource:dbsnp,known=true,training=false,truth=false,prior=2.0 reference_files/resource_bundle_dec14/dbsnp_138.b37.vcf \
...
The Infinium CoreExome-24 beadchip is a genotyping platform available from Illumina. It comprises a core set of 551,839 markers with a mean density of XXX.  Genotyping quality control was performed following the protocol from @Guo2014. Illumina’s Genome Studio vXXX genotyping module vXXX was used for the initial calling of genotypes. Samples were exported from Genome Studio that had a call rate > 98%, markers were zeroed if they were < 95%. 
...
Principle components were calculated for all 
