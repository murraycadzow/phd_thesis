...
<!-- XXX explain briefly how to get -ve fst -->
...
parallel '
  bcftools view 
    ...
    -M 2 \
    -v snps \
    -o ALL.chr{}.phase3_shapeit2_mvncall_integrated_v5a.20130502.biallelic_matched.vcf.gz \
    ALL.chr{}.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf.gz 
  ' ::: $(seq 1 22)
...
parallel '
  bcftools view \
    ...
    -M 2 \
    -v snps \
    -o NZ_coreExome.chr{}.norm.phased.biallelic_matched.vcf.gz \
...
parallel 
  'bcftools merge \
    ...
    ALL.chr{}.phase3_shapeit2_mvncall_integrated_v5a.20130502.biallelic_matched.vcf.gz \
    NZ_coreExome/NZ_coreExome.chr{}.norm.phased.biallelic_matched.vcf.gz 
  ' ::: $(seq 1 22)
```
