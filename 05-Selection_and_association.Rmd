...
The use of selection statistics in combination with \gls{gwas} is one of these methodologies that can be applied to prioritise \gls{gwas} results [@Ayodo2007, @Field2016a, @Casto2011].
