...
Experimant wide significance was defined as P < `r as.character(signif(0.005/30,2))`.
...
Compare the ukbiobank gwas results to those of the significant ihs/nsl snps in the self or \gls{ult}
