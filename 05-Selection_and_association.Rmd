...
```{r kotplot, fig.cap= '(ref:kotplot)', warning = FALSE}
...
```{r kotplot2, fig.height=7, fig.cap = '(ref:kotplot2)', warning = FALSE}
...
```{r ukOverlap, fig.cap = '(ref:ukOverlap)', fig.height = 4}
...
```{r polyManhat, fig.cap='(ref:polyManhat)', fig.width=7, fig.asp=1, out.width= '95%', fig.align='center'}
