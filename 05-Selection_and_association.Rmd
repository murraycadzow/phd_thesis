...
polyhaplogwas %>% 
  ...
  kable(., format = 'latex', booktabs = TRUE, #align = 'rrlllllrrrrlll', # unsure why alignment makes the table not display properly
        caption = "(\\#tab:polyhaplogwas) SNPs that had |iHS| or |nSL| > 2 in the New Zealand Polynesian populations and a gout association P > 2 x 10\\textsuperscript{-4} in the Polynesian GWAS.", escape = FALSE) %>% group_rows(., 'iHS', 1, 12) %>% group_rows(., "nSL", 13, 24) %>% 
