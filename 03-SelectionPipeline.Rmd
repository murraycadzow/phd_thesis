...
ddc_eas_r2 %>% dplyr::rename(`Rs number` = RS_number) %>% kable(format = 'latex', caption = '(\\#tab:ddcLd) Linkage disequillibrium in EAS populations (R^2^) between markers in _DDC_') %>% kableExtra::row_spec(0, angle = 90)
```
...
The genes from the \gls{nsl} significant pathways that were in common between \gls{cim} and \gls{nzm} were CACNA1D, ADCY9, SLC8A1, CACNA2D3, ITPR1, MYLK
