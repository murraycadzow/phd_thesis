...
The selection of samples and preliminary data preparation for the selection data set is detailed in Section \@ref(selectionDataset).



The phased \gls{vcf} files for the combined \gls{nz} and 1000 Genome

The selection statistics were calculated for the Polynesian populations 

\gls{td}, \gls{fwh}, \gls{fld}, \gls{flf}, and \gls{ze} were calculated using the Popgenome package.
