...
```{r intraSelGenes, fig.cap = '(ref:intraSelGenes)', fig.width=7}
...
Malaria is endemic in the southwest Pacific, extending out to the east as far as Vanuatu, but is absent and awlays had been absent, further west in Polynesia [@Clark1993]. There is evidence of genetic advantage against malaria of Austronesian speaking populations in Near Oceania, through which the Polynesian ancestors would have passed through prior to settlement of the Pacfic [@Clark1993;]. In Polynesia, where malaria is absent, high frequencies of  $\alpha$-thalassaemia mutations (protective against malaria) have been identified in populations not exposed to malaria [@Hill1985]. Other malaria protective mutations, such as glucose-6-phosphate dehydrogenase deficiency and $\beta$-thalassaemia, are present in Pacific populations in higher frequencies, though genrally in island groups where malaria remains extant [@Cappellini2008;@Flint1986].
