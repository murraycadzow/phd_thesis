...
As discussed in @Gosling2014, the thrifty gene hypothesis in the context of the Pacific does not fit with the anthropological history, and from this analysis it appears to have none-to-minimal support from the loci that exhibit signals of possible selection. 

XXX expand

@Ayub2014c had a similar finding with respect to \gls{t2d}. While some individual loci show some signs of selection, it appears as if selection at \gls{t2d} loci is not the case.
...
<!--XXX how does it reduce the fdr -->
...
XXX expand with some of the important results - what is the take home message from this work?
