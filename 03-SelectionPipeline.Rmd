...
superDiseaseGenesTab %>% 
  kable(., col.names = c('Population',"Super Pop",'Urate / Gout','Obesity','T2D','Kidney Disease','Metabolic Syndrome','Type'), caption = '(\\#tab:superDiseaseGenesTab) Number of Genes with evidence of possible positive selection in Super populations', format ='latex', booktab = TRUE) %>% kableExtra::kable_styling(latex_options = 'scale_down')
```
