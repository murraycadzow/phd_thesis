...
The dataset used for this chapter was a combination of the 
...
(fig:superUpset) Upset plot showing the intersections of genes that had both haplotypic and SFS evidence at the individaul population leveland were then pooled into their super population group.

```{r, fig.cap = '(ref:superUpset)', eval = TRUE}
