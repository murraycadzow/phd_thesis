...
The \gls{fdr} for \gls{ze} was 1.0 for all Polynesian populations in the lower end of the distribution and the 1st percentile of the data fell within the 2nd percentile bin from the permutations. Whereas, for \gls{td} and \gls{fwh} the quantile bin `r fdr_low_tab %>%filter(stat %in% c('Tajima.D','Fay.Wu.H')) %>% summarise(min(lowest_quant))`% with the maximum upper confidence interval being `r fdr_low_tab %>%filter(stat %in% c('Tajima.D','Fay.Wu.H')) %>% summarise(three_dp(max(upperCI)))`.
...
in figure \@ref(fig:TajimaDfdr) XXX
...
The mean Tajima's D for each chromosome can be seen in Table \@ref(tab:meanTDtable) and is found in the appendix. The mean \gls{td} for the Polynesian populations was `r global_summary %>% filter(pop %in% poly_pop, stat == 'Tajima.D') %>% summarise(m = mean(mean)) %>% .[["m"]] %>% three_dp()` with  `r gs_td_table %>% filter(pop == 'CIM') %>% .[["mean"]]` for \gls{cim}, `r gs_td_table %>% filter(pop == 'NZM') %>% .[["mean"]]` for \gls{nzm}, `r gs_td_table %>% filter(pop == 'SAM') %>% .[["mean"]]` for \gls{sam}, and `r gs_td_table %>% filter(pop == 'TON') %>% .[["mean"]]` for \gls{ton}. The means of the Polynesian populations were lower than all of the other populations except \gls{pel} and \gls{mxl}.
...
```{r, eval = FALSE}
gs_ze_table %>% mutate(min_rank = dense_rank(min), max_rank = dense_rank(desc(max)), med_rank = dense_rank(median)) %>% arrange(desc(med_rank))
```
...
```{r, fig.cap='(ref:cimFANCM)', eval= TRUE, message = FALSE}
g = "FANCM"
...
```{r, fig.cap='(ref:cimRGS3)', eval= TRUE, message = FALSE}
g = "RGS3"
#retrieve information of the gene of interest
...
THADA Plot
```{r, fig.cap='(ref:cimTHADA)', eval= TRUE, message = FALSE}
g = "THADA"
#retrieve information of the gene of interest
...
```{r, fig.cap='(ref:nzmDNAH6)', eval= TRUE, message = FALSE}
g = "DNAH6"
#retrieve information of the gene of interest
...
```{r, fig.cap='(ref:nzmRGS3)', eval= TRUE, message = FALSE}
g = "RGS3"
#retrieve information of the gene of interest
...
```{r, fig.cap='(ref:nzmSUPT3H)', eval= TRUE, message = FALSE}
g = "SUPT3H"
#retrieve information of the gene of interest
...
DNAH10 Plot
```{r, fig.cap='(ref:nzmDNAH10)', eval= TRUE, message = FALSE}
g = "DNAH10"
#retrieve information of the gene of interest
...
```{r, fig.cap='(ref:samCNTNAP5)', eval= TRUE, message = FALSE}
g = "CNTNAP5"
#retrieve information of the gene of interest
...
```{r, fig.cap='(ref:samSPAG16)', eval= TRUE, message = FALSE}
g = "SPAG16"
#retrieve information of the gene of interest
...
```{r, fig.cap='(ref:samSPECC1)', eval= TRUE, message = FALSE}
g = "SPECC1"
#retrieve information of the gene of interest
...
```{r, fig.cap='(ref:samSUPT3H)', eval= TRUE, message = FALSE}
g = "SUPT3H"
#retrieve information of the gene of interest
...
CREB1 Plot
```{r, fig.cap='(ref:samCREB1)', eval= TRUE, message = FALSE}
g = "CREB1"
#retrieve information of the gene of interest
...
```{r, fig.cap='(ref:tonCENPP)', eval= TRUE, message = FALSE}
g = "CENPP"
#retrieve information of the gene of interest
...
```{r, fig.cap='(ref:tonSH3RF1)', eval= TRUE, message = FALSE}
g = "SH3RF1"
#retrieve information of the gene of interest
...
```{r, fig.cap='(ref:tonSUPT3H)', eval= TRUE, message = FALSE}
g = "SUPT3H"
#retrieve information of the gene of interest
...
NRXN3 Plot
```{r, fig.cap='(ref:tonNRXN3)', eval= TRUE, message = FALSE}
g = "NRXN3"
#retrieve information of the gene of interest
...
THADA Plot
```{r, fig.cap='(ref:tonTHADA)', eval= TRUE, message = FALSE}
g = 'THADA'
#retrieve information of the gene of interest
